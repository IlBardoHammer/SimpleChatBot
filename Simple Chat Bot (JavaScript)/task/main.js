...
function test() {
  console.log(`
    ...
    Why do we use methods? (You have 4 chances)
  ...
  for (i = 0; i <= 4; i++) {
    answerInput = Number(input());
    if (answerInput === 2) {
      end();
      break;
    } else if (answerInput > 4 || answerInput < 1) {
      console.log("The answers goes 1 to 4. No more, no less :)");
    }
